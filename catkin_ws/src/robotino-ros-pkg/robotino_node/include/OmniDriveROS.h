...
private:
	...
	double dyn_max_linear_vel_;
	double dyn_min_linear_vel_;
	double dyn_max_angular_vel_;
	double dyn_min_angular_vel_;
...
public:
	...
	void setDynMaxMin( double dyn_max_linear_vel, double dyn_min_linear_vel,
				double dyn_max_angular_vel, double dy_min_angular_vel );
};
